...
struct BulgarianSplitSquatThresholds {
  var standingKneeMin = 150.0  // front knee nearly straight at the top
  var standingSpineMax = 35.0  // a forward lean is normal in a hip-dominant split squat
  var descendingKneeThreshold = 140.0
  var ascendingKneeThreshold = 95.0
  var maxValidSpineAngle = 60.0
  /// Rear ankle must sit this much higher than the front ankle (as a fraction of the front leg length) to vote.
  var elevationVoteFraction = 0.2
}

final class BulgarianSplitSquatAnalyzer: ExerciseAnalyzer {
  ...
  let kind = ExerciseKind.bulgarianSplitSquat
  ...
  init(thresholds: BulgarianSplitSquatThresholds = BulgarianSplitSquatThresholds()) {
