...
public struct PistolSquatThresholds {
  public init() {}
  public var standingKneeMin = 150.0  // working knee nearly straight
  public var standingSpineMax = 25.0  // relatively upright
  public var descendingKneeThreshold = 140.0  // start descending when the knee drops below this
  public var ascendingKneeThreshold = 90.0  // start ascending when the knee rises above this
  public var maxValidSpineAngle = 60.0  // reject frames where the person is basically horizontal
}

/// Frame bookkeeping the head-travel checkpoints need.
public struct SingleLegFrame {
  public let pose: Pose
  public let time: Double
  public let earY: Double
  public let metrics: [String: Double]
}

public final class PistolSquatAnalyzer: ExerciseAnalyzer {
  ...
  public let kind = ExerciseKind.pistolSquat
  ...
  public init(thresholds: PistolSquatThresholds = PistolSquatThresholds()) {
  ...
  private func updateBottomCandidate(_ frame: SingleLegFrame, image: () -> CGImage?) {
...
public final class SingleLegTracker {
  ...
  public init(asymmetryVoteThreshold: Double) {
  ...
  public func vote(skeleton: BodySkeleton) {
  ...
  public func vote(for side: BodySide) {
    guard workingLeg == nil else { return }
  ...
  public static func depthPercent(knee: Double) -> Double {
