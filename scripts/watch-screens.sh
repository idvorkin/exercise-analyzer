...
for state in disconnected background idle live recording paused done viewfinder workoutStart workout workoutEnd workoutRecording workoutViewfinder; do shoot "$state"; done
exit $fail
