...
| Recording | `camera_start`, `camera_switch`, `camera_level`, `camera_done` (duration_s, frames_delivered/analyzed, live_reps; with live bells: live_bell_frames, live_bell_avg_infer_ms, live_fps, live_bells_dropped), `camera_cancel`, `recording_partial`, `stitch` (rotation segments), `empty_recording`, `recording_deleted`, `keep_awake` |
