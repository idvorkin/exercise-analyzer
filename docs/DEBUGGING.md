...
| Trim, save, Photos | `trim_start`, `trim` (requested_start_s, start_s, reps), `trim_done` (passthrough), `trim_skipped`, `trim_undo`, `replace_prompt` (clip, seconds: a Photos clip was trimmed and the replace-the-original sheet is up, #90; the answer is `ui` action replace_original, choice replace / keep), `saved`, `photos_replaced`, `photos_restored`, `photos_suggestions` (matched, already_analyzed, new, ignored, shown: the three tabs of story 052, each capped at 12), `photos_ignore` (ignored: true for "Not a workout clip", false for "Bring back"; total_ignored, #93), `photos_suggestion_open`, `photos_fetch` (seconds, in_cloud, found, error) |
