...
- **Then:** one slim line above the phase pills reads "‹ Workout ♥ 150 · −32 · avg 138" (Igor, on the first build: "too much space used, just workout … the single line"), all of it the button back to the workout: the same peak and drop its row on the workout's page shows (053), a rest under a minute says its length ("−20/30s"), and a set with no readings shows nothing
