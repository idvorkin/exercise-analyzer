...
- **Then:** beside "‹ Workout 8:43 AM" it says "♥ 150 · −32 · avg 138", the same peak and drop its row on the workout's page shows (053), a rest under a minute says its length ("−20/30s"), and a set with no readings shows nothing
