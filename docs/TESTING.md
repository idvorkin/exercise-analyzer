...
| `SWING_WORKOUTS_FOLDED=1` | with `SWING_SHOW_WORKOUTS=1`: every day starts folded, so the folded headers' "8×8 [swing]" chips (#129) and the workout lines under them are on the first screen |
